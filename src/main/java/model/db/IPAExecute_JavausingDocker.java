...
public class IPAExecute_JavausingDocker extends IPAExecute {
	 ...
	 * 
	 */
	public IPAExecute_JavausingDocker() {
		// TODO Auto-generated constructor stub
	}

	/* (non-Javadoc)
	 * @see model.db.IPAExecute#executeIPA(model.db.IPADTO, model.db.InputDatasetDTO)
	 */
	@Override
...
//			}
	        ...
	        int lastExitCode = runCommands( docker, containerId, commands, 
	        		lastOutput, successCount ) ;
	    ...
	    throws DockerException, InterruptedException {
	    	...
	    	System.out.println( "In startContainer  imageName: " + imageName +
