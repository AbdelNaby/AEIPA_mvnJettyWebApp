...
public abstract class DBConnection {
	...
	public abstract ArrayList<String> selectDataFromDB(String tableName, String attributeValue, String conditionOp, String value);
	public abstract void terminateDBConnection();
	public abstract ArrayList<String> selectDataFromDB_MultiCondition(String tableName, ArrayList<String> chkAttributeList,
